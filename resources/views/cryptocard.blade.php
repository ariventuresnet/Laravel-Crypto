                            ...
                            @foreach ($cards as $card)
                                <tr class="exchange-row">
                                    <td class="exchange-name">
                                        {{-- <a href="{{route('cryptocurrency.show', $card->id)}}" class="text-dark text-nowrap"> <img src="{{asset('images/') . "/" . $card->logo}}" class="rounded-circle" width="15%" alt="Exchange Logo"> {{$card->name}}</a> --}}
                                        <a href="#" class="text-dark text-nowrap"> <img src="{{asset('images/') . "/" . $card->logo}}" class="rounded-circle" width="15%" alt="card Logo"> {{$card->name}}</a>
                                    </td>
                                    <td>{{$card->ease}}</td>
                                    <td>{{$card->privacy}}</td>
                                    <td>{{$card->speed}}</td>
