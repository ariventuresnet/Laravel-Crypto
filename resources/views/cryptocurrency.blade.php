        ...
        <div class="container-fluid pt-md-4 px-md-5 pb-sm-3 wrapper">
            <div class="row">
                <div class="col-6 col-sm-4 col-lg-2 pr-md-0">
                    <a href="{{URL::to('cryptocurrency')}}" class="btn btn-home px-lg-3 px-2 mb-2" id="bitcoin"> <span class="float-left">Bitcoin Dashboard</span></a>           
                </div>
                <div class="col-6 col-sm-4 col-lg-2 pr-md-0">
    ...
    <section class="container-fluid px-5">
        <div class="row mb-5">
            <div class="col-md-8">
                ...
                <span class="change-percent font-weight-bold"> (<span class="value">{{$states['RAW']['BTC']['USD']['CHANGEPCT24HOUR']}}</span>%)</span>
            ...
            <div class="col-md-4">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item font-weight-bold"><span class="float-left">Chg. 24H</span> <span class="float-right current-percent">{{$states['RAW']['BTC']['USD']['CHANGEPCT24HOUR']}} %</span></li>
                </ul>
            </div>
        </div>
