<section class="container-fluid px-md-5 px-2 py-md-4 py-3">
    ...
    <div class="row">
        <div class="col-md-7">
            @foreach ($posts["exchange"] as $post)
                <a href="{{route('exchange.post', $post->slug)}}"><img src="{{asset('images/') . "/" . $post->img}}" class="img-fluid rounded" alt="Responsive image" width="85%"></a>
