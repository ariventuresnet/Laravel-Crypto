                                ...
                                <form action="{{route('currencies.update', $currency->id)}}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select multiple name="categories[]" class="chosen" id="categories" data-placeholder="Select Categories...">
                                          <option value="exchange" {{ $currency->is_exchange == 1 ? 'selected' : '' }}>Exchange</option>
                                          <option value="card" {{ $currency->is_card == 1 ? 'selected' : '' }}>Card</option>
                                          <option value="loan" {{ $currency->is_loan == 1 ? 'selected' : '' }}>Loan</option>
                                          <option value="wallet" {{ $currency->is_wallet== 1 ? 'selected' : '' }}>Wallet</option>
                                        </select>
                                    </div>
