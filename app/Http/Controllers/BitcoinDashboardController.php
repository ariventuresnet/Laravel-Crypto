...
class BitcoinDashboardController extends Controller
{
    ...
    private function makeResult(){
        ...
        $x = 5;
        $output["firstyr_bitcoin"] = $this->cbstates[$x++];
        $output["firstyr_gold"] = $this->cbstates[$x++];
        $output["firstyr_sp"] = $this->cbstates[$x++];
        $x++;
        $output["secondyr_bitcoin"] = $this->cbstates[$x++];
        $output["secondyr_gold"] = $this->cbstates[$x++];
        $output["secondyr_sp"] = $this->cbstates[$x++];
        $x++;
        $output["thirdyr_bitcoin"] = $this->cbstates[$x++];
        $output["thirdyr_gold"] = $this->cbstates[$x++];
        $output["thirdyr_sp"] = $this->cbstates[$x++];
        $x++;
        $output["fourthyr_bitcoin"] = $this->cbstates[$x++];
        $output["fourthyr_gold"] = $this->cbstates[$x++];
        $output["fourthyr_sp"] = $this->cbstates[$x++];
        $x++;
        $output["fifthyr_bitcoin"] = $this->cbstates[$x++];
        ...
        $output["mcap_close_r2"] = $this->cbstates[$x++];
        $output["mcap_close_days_r2"] = $this->cbstates[$x++];
        $output["mcap_close_per_r2"] = $this->cbstates[$x++];
        $output["mcap_close_r3"] = $this->cbstates[$x++];
        $output["mcap_close_days_r3"] = $this->cbstates[$x++];
        $output["mcap_close_per_r3"] = $this->cbstates[$x++];
        ...
        // $output["price_close_per_r1"] = $this->cbstates[$x++];
        // $output["price_close_r2"] = $this->cbstates[$x++];
        // $output["price_close_days_r2"] = $this->cbstates[$x++];
        // $output["price_close_per_r2"] = $this->cbstates[$x++];
        // $output["price_close_r3"] = $this->cbstates[$x++];
        // $output["price_close_days_r3"] = $this->cbstates[$x++];
        // $output["price_close_per_r3"] = $this->cbstates[$x++];
        ...
        $x = count($this->cbstates) -1;     //95
        $output["roi_today_r10"] = $this->cbstates[$x--];
        $output["roi_price_r10"] = $this->cbstates[$x--];
        $output["roi_date_r10"] = $this->cbstates[$x--];
        $output["roi_today_r9"] = $this->cbstates[$x--];
        $output["roi_price_r9"] = $this->cbstates[$x--];
        $output["roi_date_r9"] = $this->cbstates[$x--];
        $output["roi_today_r8"] = $this->cbstates[$x--];
        $output["roi_price_r8"] = $this->cbstates[$x--];
        $output["roi_date_r8"] = $this->cbstates[$x--];
        $output["roi_today_r7"] = $this->cbstates[$x--];
        $output["roi_price_r7"] = $this->cbstates[$x--];
        $output["roi_date_r7"] = $this->cbstates[$x--];
        $output["roi_today_r6"] = $this->cbstates[$x--];
        $output["roi_price_r6"] = $this->cbstates[$x--];
        $output["roi_date_r6"] = $this->cbstates[$x--];
        $output["roi_today_r5"] = $this->cbstates[$x--];
        $output["roi_price_r5"] = $this->cbstates[$x--];
        $output["roi_date_r5"] = $this->cbstates[$x--];
        $output["roi_today_r4"] = $this->cbstates[$x--];
        $output["roi_price_r4"] = $this->cbstates[$x--];
        $output["roi_date_r4"] = $this->cbstates[$x--];
        $output["roi_today_r3"] = $this->cbstates[$x--];
        $output["roi_price_r3"] = $this->cbstates[$x--];
        $output["roi_date_r3"] = $this->cbstates[$x--];
        $output["roi_today_r2"] = $this->cbstates[$x--];
        $output["roi_price_r2"] = $this->cbstates[$x--];
        $output["roi_date_r2"] = $this->cbstates[$x--];
        $output["roi_today_r1"] = $this->cbstates[$x--];
